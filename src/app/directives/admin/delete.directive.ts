...
export class DeleteDirective {
  ...
  constructor(private element: ElementRef, private _renderer: Renderer2, private http: HttpClientService, private dialog: MatDialog, private alertify: AlertifyService) {
